...
Future<void> callRequesterDetailDialog(Call call) {
  ...
  CallRequesterDetailDialogController controller = Get.put(CallRequesterDetailDialogController(call));

  return showDialog(
    context: Get.context!,
    builder: (_) => AlertDialog(
      title: AppBar(title: Text(call.callType!.title!), forceMaterialTransparency: true, actions: [CustomDropDownButton(itens: controller.itens), ]),
      content: SizedBox(
        width: 1200,
        child: SingleChildScrollView(
          child: Column(
            children: [
              Row(
                children: [
                  CustomExpandedTextField(controller: TextEditingController(text: call.callType!.title), labelText: 'Titulo',),
                  addHorizontalSpace(10),
                  CustomExpandedTextField(controller: TextEditingController(text: call.callType!.sector!.name), labelText: 'Setor',),
                  addHorizontalSpace(10),
                  CustomExpandedTextField(controller: TextEditingController(text: DateFormat('dd/MM/yyyy - HH:mm:ss').format(DateTime.parse(call.dataCriacao))), labelText: 'Abertura',),
                  addHorizontalSpace(10),
              ...
              Row(
                children: [
                  ...
                  addHorizontalSpace(10),
                  CustomExpandedTextField(controller: TextEditingController(text: call.callType!.priority!.name), labelText: 'Prioridade',),                              
                  addHorizontalSpace(10),
