              ...
              children: [  
                Row(
                  children: [
                    ...
                    CustomExpandedTextField(controller: controller.tituloC, labelText: 'Titulo', readOnly: true,),
                    addHorizontalSpace(10),
                    CustomExpandedTextField(controller: controller.setorC, labelText: 'Setor', readOnly: true,),
                    addHorizontalSpace(10),
                    CustomExpandedTextField(controller: controller.prioridadeC, labelText: 'Prioridade', readOnly: true,),
                  ],
                ),
                addVerticalSpace(10),
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        isExpanded: true,
                        hint: Text('Select Item', style: Get.theme.inputDecorationTheme.counterStyle,),
                        items: controller.status.map((String item) => DropdownMenuItem<String>(value: item, child: Text(item, style: Get.theme.inputDecorationTheme.counterStyle,),)).toList(),
                        value: controller.statusC.value,
                        onChanged: (String? value) => controller.setStatusValue(value!),
