...
class MenuDrawerController extends GetxController {
  ...
  Rx<Widget> themeData = cInkWell(50, 55, Icons.dark_mode, Icons.dark_mode_outlined, Get.theme.colorScheme.primary , null, 'Dark Mode', () => Get.changeThemeMode(ThemeMode.dark),).obs;
