import 'package:chamados/app/modules/call_requester/components/call_requester_detail_dialog_controller.dart';
            ...
            children: [
              Row(
                children: [
                  ...
                  CustomExpandedTextField(
                    controller: TextEditingController(
                        text: DateFormat('dd/MM/yyyy - HH:mm:ss').format(DateTime.parse(controller.call.dataCriacao))),
                    labelText: 'Abertura',
                  ),
                  addHorizontalSpace(10),
                  CustomExpandedTextField(
              ...
              Row(
                children: [
                  ...
                  CustomExpandedTextField(
                    controller: TextEditingController(
                        text: controller.call.callType!.priority!.name),
