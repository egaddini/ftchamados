        ...
        child: Column(
          children: <Widget>[
            UserAccountsDrawerHeader(
              ...
              currentAccountPicture: InkWell(onHover: (value) {
                controller.currentAccountPictureSize.value = value ? 80 : 70;
              },
                //onTap: () => Get.to(EditUserPage(controller.logedUser.value), routeName: 'edit-user/{controller.logedUser.email!}'),
              child: Tooltip(message: 'Minha Conta',child: CircleAvatar(child: Text(logedUser.email!.substring(0, 2)),)),),
              otherAccountsPictures: [
                Badge(
                  alignment: const Alignment(0, -1.10), label: Text('${controller.notificacoes.value}', style: const TextStyle(fontSize: 10),),
