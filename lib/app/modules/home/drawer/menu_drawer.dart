...
class MenuDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final MenuDrawerController controller =
        Get.put(MenuDrawerController(logedUser: user.obs));
          ...
          children: <Widget>[
            UserAccountsDrawerHeader(
              ...
              currentAccountPictureSize: Size(
                  controller.currentAccountPictureSize.value,
                  controller.currentAccountPictureSize.value),
              currentAccountPicture: InkWell(
                ...
                child: Tooltip(
                    ...
                    child: CircleAvatar(
                      child: Text(
                          controller.logedUser.value.email!.substring(0, 2)),
                    )),
              ),
