...
void userDetailsDialog(UserInfoModel user) {
  Get.lazyPut(
    () => UserDetailsDialogController(user),
  );
  showDialog(
      context: Get.context!,
                            ...
                            children: [
                              ...
                              PasswordField(
                                  ...
                                  validator: [
                                    Validatorless.required(
                                        'É obrigatório inserir a Senha Atual'),
                                    Validatorless.min(6,
                                        'Senha Atual precisa ter no mínimo 6 caracteres'),
                                  ]),
                              addVerticalSpace(10),
                              PasswordField(
                                  ...
                                  validator: [
                                    ...
                                    Validators.difere(controller.senhaAtualEC,
                              ...
                              PasswordField(
                                  ...
                                  validator: [
                                    ...
                                    Validators.compare(controller.passwordEC,
...
Widget dropDownButton(
    List<SectorModel> items, List<SectorModel> selectedItems) {
